...
import { Mascot, PawMark } from '../components/Mascot';
...
export function People() {
  ...
  return <div className="page people-page"><div className="collection-hero people-hero"><div><div className="eyebrow muted">THE PEOPLE BEHIND THE PLUS</div><h1>每一页，<br />都有一个有趣的人。</h1><p>有人写下第一行代码，有人为想法搭一座桥。<br />这里收录一起创造、分享，也默默支持 I++ 的人。</p><div className="collection-note"><BookOpen size={17} />核心成员与支持者 · 按年级收录，不以头衔排序</div></div><div className="shelf-mascot"><span className="mascot-caption">好奇心，请翻到下一页。</span><Mascot /><div className="mascot-shelf"><i /><i /><i /><span>I++ LIBRARY</span></div></div></div>
