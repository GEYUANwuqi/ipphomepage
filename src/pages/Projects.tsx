...
export function Projects() {
  ...
  return <div className="page projects-page"><div className="collection-hero"><div><h1>我们做的项目</h1><p>这里收录 IppClub 与相关社区的项目。</p></div><div className="project-hero-symbol" aria-hidden="true"><span>{'{'}<b>++</b>{'}'}</span></div></div>
    ...
    <section className="creation-path" aria-labelledby="creation-title"><div><h2 id="creation-title">上手 Dora SSR</h2></div><div className="creation-links"><ExternalLink href="https://dora-ssr.net/docs/tutorial/quick-start"><BookOpen size={20} /><span>01 / 阅读入门文档</span></ExternalLink><ExternalLink href="https://github.com/IppClub/Dora-Example"><Code2 size={20} /><span>02 / 动手修改示例</span></ExternalLink><Link to="/events"><Trophy size={20} /><span>03 / 关注赛事展台</span><ArrowRight size={18} /></Link></div></section>
